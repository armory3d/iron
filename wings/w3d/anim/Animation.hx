...
class AnimatedObject {
	...
	public var targetObject : wings.w3d.Object;
	public var targetSkin : wings.w3d.scene.Skin;
...
class Animation {
	...
	**/
	...
	public function createInstance( base : wings.w3d.Object ) {
		var currentSkin : wings.w3d.scene.Skin = null;
	...
	**/
	@:access(wings.w3d.scene.Skin.skinData)
	public function bind( base : wings.w3d.Object ) {
		var currentSkin : wings.w3d.scene.Skin = null;
		for( a in objects ) {
			if( currentSkin != null ) {
			...
			var obj:wings.w3d.Object = base.getObjectByName(a.objectName);
			if( obj == null )
				throw a.objectName + " was not found";
			#if flash
			var joint = null;
			#else
			var joint = Std.instance(obj, wings.w3d.scene.Skin.Joint);
			#end
			if( joint != null ) {
