...
class FbxGeometry extends Geometry {
	...
	public var library:wings.w3d.fbx.Library;
	public var geom(default, null):wings.w3d.fbx.Geometry;
	public var skin:wings.w3d.anim.Skin;
	public var multiMaterial:Bool;

	public function new(data:String, geometry:wings.w3d.fbx.Geometry = null) {

		library = new wings.w3d.fbx.Library();
		...
		if( gt == null ) gt = new wings.w3d.fbx.Point();
		...
		var sbuf = (skin == null ? null : new haxe.io.BytesOutput());// hxd.BytesBuffer());
