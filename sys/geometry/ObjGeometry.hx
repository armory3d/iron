...
class ObjGeometry extends Geometry {
	...
	var indexedVertices:Array<Float>;
	var indexedUVs:Array<Float>;
	var indexedNormals:Array<Float>;
	...
	function _build(_vertices:Array<Float>, _uvs:Array<Float>, _normals:Array<Float>) {
