...
class EmitterMold {
    ...
    public function new(data:String) {
        ...
        for (element in xml.firstElement().elements()) {
            ...
            case "texture":
                texture = wings.wxd.Assets.getImage(element.get("name"));
            case "angle":
    ...
    static function getFloat(xml:Xml, name:String):Float {
        return Std.parseFloat(xml.get(name));
    }

    static inline function getValue(xml:Xml):Float {
        return getFloat(xml, "value");
    }

    static inline function getX(xml:Xml):Float {
        return getFloat(xml, "x");
    }

    static inline function getY(xml:Xml):Float {
