...
class Object {
	 ...
	 *
	 * @param	name The name of the game Object instance to be removed.
	 * @param	keepTransform Keep the transform given by the parent or revert to the objects default. Optional (default false).
