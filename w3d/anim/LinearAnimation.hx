...
class LinearObject extends AnimatedObject {
	...
	public var matrix : wings.math.Mat4;
	...
	override function sync( decompose = false ) {
		...
		for( o in getFrames() ) {
			...
			if( o.uvs != null ) {
				/*var mat = o.targetObject.toMesh().material;
				if( mat.uvDelta == null ) {
					mat.uvDelta = new wings.w3d.fbx.Vector();
			...
			//var skin = o.targetSkin;
			//trace(skin.currentPalette.length);
